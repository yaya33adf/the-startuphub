import { QrCode, DollarSign, Receipt, FileSpreadsheet, BarChart3, Mail, Target, Users, CalendarDays, Shield, UserSquare2 } from "lucide-react";
...
export const tools = [
  {
    ...
    description: "Create detailed user personas for your target audience",
    icon: UserSquare2,
