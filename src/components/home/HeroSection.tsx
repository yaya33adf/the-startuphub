...
export const HeroSection = ({ searchResults, onSearchResults }: HeroSectionProps) => {
  return (
    <section className="py-20 px-4 text-center bg-gradient-to-b from-primary/20 via-accent/10 to-background relative overflow-hidden">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-bold mb-8 animate-fade-in">
          Welcome to The Startup Hub
        </h1>
        <div className="relative z-10 animate-scale-in mb-12">
          <ClimbingAnimation />
        </div>
